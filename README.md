...
## Built APK
We've also got a pre-built, ready to test apk version to test on your android device: [WeCare.apk](http://www.mediafire.com/file/cgx5aipcqch8ma0/app-debug2.apk/file)
## About the backend
